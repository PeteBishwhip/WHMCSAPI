...
class DomainGetLockingStatusTest extends BaseTest
{

    public function testCanUseDomainGetLockingStatusCommand()
    {
        $GLOBALS['whmcsApi']->command('DomainGetLockingStatus');
        $this->assertEquals('DomainGetLockingStatus', $GLOBALS['whmcsApi']->action);
    }
